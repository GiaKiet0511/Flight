...
foreach ($list as $item) {
    $strcatid .= "<option value='" . $item['id'] . "'>" . $item['username'] . "</option>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="hold-transition login-page">
    ...
    if (isset($_POST['DANGKY'])) {
        ...
        header("location:index.php?option=account/success");
    }
    ?>
    <div class="login-box">
            ...
            <div class="card-body login-card-body">
                ...
                <form action="" name="frm1" method="post">
                    <div class="input-group mb-3">
                        <input name="data[username]" type="text" required class="form-control"
                    ...
                    <div class="input-group mb-3">
                        <input name="data[password]" type="password" required class="form-control"
