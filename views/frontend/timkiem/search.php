...
<div class="content">
    <div class="container">
        ...
        <div id="left_ads_float" style="bottom:24px; left: 80px; position:absolute; top:650px">
            <a href="#" target="_blank"><img src="public/banner/banner1.jpg" style="width:300px; height:350px" /></a>
        </div>
        <div id="left_ads_float" style="bottom:24px; left: 80px; position:absolute; top:1000px">
        ...
        <?php foreach ($list2 as $row): ?>
            <div class="ticket_information" style="float:right">
                ...
                <div class="time_flights" style="clear:both; padding-left:15px">Giờ đi:
                    <?php echo $row['GioDi'] ?>
                </div>
                <div class="time_end" style="position: relative;top:-24px;left:220px">Giờ đến:
                    <?php echo $row['GioDen'] ?>
                </div>
                <div class="location_start" style="padding-left:15px">Điểm đi:
                    <?php echo $row['DiemDi'] ?>
                </div>
                <div class="location_end" style="position: relative;top:-24px;left:220px">Điểm đến:
                    <?php echo $row['DiemDen'] ?>
                </div>
                <div class="date_start" style="padding-left:15px">Ngày bay:
                    <?php echo $row['NgayBay'] ?>
                </div>
                <div class="seat_class1" style="padding-left:15px;position: relative;top:-24px;left:205px">Hạng ghế:
                    <?php echo $row['HangGhe'] ?>
                </div>
                <div class="price" style="position: relative;bottom:35px;right:15px">
                    <div class="money" style="text-align:center;color:red">
                        <?php echo $row['GiaTien'] ?>/Khách
                    </div>
                    <div class="select"><a href="index.php?option=datve/dat-ve"><button class="click">Chọn</button></a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
