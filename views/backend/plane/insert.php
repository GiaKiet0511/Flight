        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <strong class="text-danger">THÊM MÁY BAY</strong>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[MaMayBay]" id="MaMayBay" type="int" class="form-control" required
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[TenMayBay]" id="TenMayBay" type="text" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[img]" id="img" type="img" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                    </div>
