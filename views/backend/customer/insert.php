                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[MaKH]" id="MaKH" type="int" class="form-control" required
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[TenKhachHang]" id="TenKhachHang" type="text" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[GioiTinh]" id="GioiTinh" type="int" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                        <div class="col-md-3">
