    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <strong class="text-danger">KHÁCH HÀNG</strong>
                    </div>
                    ...
                    <tbody>
                        <?php foreach ($list as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="index.php?option=customer&cat=update&MaKH=<?php echo $row['MaKH'];?>" class="btn btn-sm btn-info">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <a href="index.php?option=customer&cat=deltrash&MaKH=<?php echo $row['MaKH'];?>" class="btn btn-sm btn-danger">
