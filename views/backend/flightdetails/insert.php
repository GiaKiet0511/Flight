        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <strong class="text-danger">THÊM CHI TIẾT CHUYẾN BAY</strong>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="MaCTChuyenBay">Mã Chi Tiết Chuyến Bay</label>
                                <input name="data[MaCTChuyenBay]" id="MaCTChuyenBay" type="int" class="form-control" required
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[ThoiGianDung]" id="ThoiGianDung" type="date" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                    </div>
