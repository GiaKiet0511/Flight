        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <strong class="text-danger">THÊM TUYẾN BAY</strong>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[MaTuyenBay]" id="MaTuyenBay" type="int" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="NoiDi">Tên Khách Hàng</label>
                                <input name="data[NoiDi]" id="NoiDi" type="text" class="form-control" required
                                    placeholder="Nhập dữ liệu" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="data[NoiDen]" id="NoiDen" type="text"
